	...
	$.jstree.plugin("core", {
		...
		_fn : { 
			init	: function () { 
				...
				this.get_container().html("<ul><li class='jstree-last jstree-leaf'><ins>&#160;</ins><a class='jstree-loading' href='#'><ins class='jstree-icon'>&#160;</ins><span class='insideTreeText'>" + this._get_settings().core.strings.loading + "</span></a></li></ul>");
